...
<template>
    ...
    <div class="w-full min-h-[62px] h-auto flex flex-row bg-[#f0f2f5] items-center">
        <button class="pl-6 cursor-pointer mr-4">
            <svg viewBox="0 0 24 24" width="30" preserveAspectRatio="xMidYMid meet" class="x11xpdln x1d8287x x1h4ghdb">
                <title>plus</title>
