...
<template>
    ...
    <div class="flex flex-col mt-auto mb-4 gap-y-2">
        ...
        <router-link to="/profile">
            <button class="w-[40px] h-[40px] rounded-full flex justify-center items-center cursor-pointer">
                <img class="w-full h-full rounded-full" src="../../barcelona-logo.jpg" alt="">
            </button>
        </router-link>
    </div>
</template>